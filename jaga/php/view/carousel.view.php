			...
			$html .= "<!-- START SLIDES -->\n\n";
				...
				if ($_SESSION['channelKey'] == 'www') { // jaga.io
					...
					if ($urlArray[0] == 'first-snow-contest') {
						...
						$html .= "\t\t\t\t<div class=\"carousel-inner\">
						<div class=\"item active\"><a href=\"/first-snow-contest/\"><img src=\"/jaga/images/carousel-bistrot-le-cochon-first-snow-contest.jpg\" alt=\"Niseko French Cuisine\" style=\"margin-left:auto;margin-right:auto;\"></a></div>
